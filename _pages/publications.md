...
{% for publi in site.publications reversed %}
  ...
  <li class="flex-item2">
    ...
    {% if publi.ood == true %} <a class="btn-ood" style="text-decoration:none; color:#ebebeb; hover:#ebebeb;" role="button" aria-expanded="false" aria-controls="{{publi.pdf}}2">OOD</a> {% endif %}
    ...
    {% if publi.ossl == true %} <a class="btn-ossl" style="text-decoration:none; color:#ebebeb; hover:#ebebeb;" role="button" aria-expanded="false" aria-controls="{{publi.pdf}}2">OSSL</a> {% endif %}
